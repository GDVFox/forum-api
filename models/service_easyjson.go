...
func easyjsonCd93bc43DecodeForumApiModels(in *jlexer.Lexer, out *Status) {
...
func easyjsonCd93bc43EncodeForumApiModels(out *jwriter.Writer, in Status) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Status) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonCd93bc43EncodeForumApiModels(&w, v)
...
func (v *Status) UnmarshalJSON(data []byte) error {
	...
	easyjsonCd93bc43DecodeForumApiModels(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Status) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonCd93bc43DecodeForumApiModels(l, v)
}
