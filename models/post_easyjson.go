...
func easyjson5a72dc82DecodeForumApiModels(in *jlexer.Lexer, out *Posts) {
...
func easyjson5a72dc82EncodeForumApiModels(out *jwriter.Writer, in Posts) {
...
func (v Posts) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5a72dc82EncodeForumApiModels(&w, v)
...
func (v *Posts) UnmarshalJSON(data []byte) error {
	...
	easyjson5a72dc82DecodeForumApiModels(&r, v)
	return r.Error()
}
